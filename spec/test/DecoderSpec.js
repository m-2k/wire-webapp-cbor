...
describe('CBOR.Decoder', () => {
  ...
  it('decodes floats', () => {
    ...
    expect(3.4028234663852886e+38).toBe(decoder('fa7f7fffff').f32());
    ...
    expect(1.0e+300).toBe(decoder('fb7e37e43c8800759c').f64());
  ...
  it('decodes text', () => {
    expect('dfsdfsdf\r\nsdf\r\nhello\r\nsdfsfsdfs').toBe(decoder('781f64667364667364660d0a7364660d0a68656c6c6f0d0a736466736673646673').text());
