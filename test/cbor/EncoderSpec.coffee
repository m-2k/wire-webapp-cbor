...
describe 'CBOR Encoder', ->
  ...
  encoded = (expected, closure) ->
    e = new CBOR.Encoder()
    closure e
    assert(to_hex(new Uint8Array e.get_buffer()) is expected)
  ...
  it 'bytes', ->
    encoded '4401020304', (e) -> e.bytes new Uint8Array [1, 2, 3, 4]

  it 'text', ->
    encoded '62c3bc', (e) -> e.text '\u00fc'
    encoded '781f64667364667364660d0a7364660d0a68656c6c6f0d0a736466736673646673', (e) ->
      e.text 'dfsdfsdf\r\nsdf\r\nhello\r\nsdfsfsdfs'
